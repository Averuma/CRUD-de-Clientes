...
<body class="antialiased">
    <div
        ...
        <div class="p-6 mx-auto max-w-7xl lg:p-8">
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-1 lg:gap-8">
                    <a href="https://github.com/Averuma/CRUD-de-Clientes.git"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Sistema de Cadastro de
                                Clientes</h2>

                            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                Sistema CRUD de cadastro de clientes com Laravel. Gerencie
                                informações facilmente com operações de criação, leitura, atualização e exclusão de
                                dados.
                            </p>
                        </div>
            ...
            <div class="flex justify-center px-0 mt-16 sm:items-center sm:justify-between">
                <div class="text-sm text-center text-gray-500 dark:text-gray-400 sm:text-left">
                    <div class="flex items-center gap-4">
                        <a href="https://github.com/Averuma"
